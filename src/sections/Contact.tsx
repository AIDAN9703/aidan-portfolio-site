            ...
            <div className="liquid-glass p-4 sm:p-6 md:p-8">
              ...
              <div className="space-y-3 sm:space-y-4">
                <div className="flex items-center space-x-3 sm:space-x-4">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 liquid-glass flex items-center justify-center flex-shrink-0">
                    <svg
          ...
          <div className="liquid-glass p-4 sm:p-6 md:p-8">
            ...
            <form className="space-y-4 sm:space-y-6">
              <div>
                ...
                <input
                  type="text"
                  className="w-full px-3 sm:px-4 py-2 sm:py-3 text-sm sm:text-base liquid-glass border border-[var(--primary)] focus:border-[var(--primary-dark)] focus:outline-none transition-colors"
              ...
              <div>
                ...
                <textarea
                  rows={4}
                  className="w-full px-3 sm:px-4 py-2 sm:py-3 text-sm sm:text-base liquid-glass border border-[var(--primary)] focus:border-[var(--primary-dark)] focus:outline-none transition-colors resize-none"
